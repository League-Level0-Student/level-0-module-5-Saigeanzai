...
String codeTime = JOptionPane.showInputDialog("how many hours have you spent coding this week?");	
// 2. If it is less than or equal to 2, tell them to stop watching YouTube and
	// write code instead.
int codeHour = Integer.parseInt(codeTime);
